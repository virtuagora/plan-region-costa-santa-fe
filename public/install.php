...
try {
    if (Capsule::schema()->hasTable('ajustes')) {
        ...
        Capsule::table('localidades')->insert([
            ...
            ['departamento_id' => 4, 'nombre' => 'Campo Garay (Juan de Garay)'],
            ['departamento_id' => 4, 'nombre' => 'Esteban Rams'],
            ['departamento_id' => 4, 'nombre' => 'Gato Colorado'],
            ['departamento_id' => 4, 'nombre' => 'Gregoria Pérez de Denis'],
            ...
            ['departamento_id' => 5, 'nombre' => 'Aldao (Colonia)'],
            ...
            ['departamento_id' => 5, 'nombre' => 'Bicha (Colonia)'],
            ['departamento_id' => 5, 'nombre' => 'Bigand (Colonia)'],
            ['departamento_id' => 5, 'nombre' => 'Castellanos (Colonia)'],
            ['departamento_id' => 5, 'nombre' => 'Clucellas (Plaza)'],
            ...
            ['departamento_id' => 5, 'nombre' => 'Saguier (Estación)'],
            ['departamento_id' => 5, 'nombre' => 'San Antonio (Pueblo)'],
            ...
            ['departamento_id' => 5, 'nombre' => 'Tacurales (Colonia)'],
            ['departamento_id' => 5, 'nombre' => 'Vila'],
            ['departamento_id' => 5, 'nombre' => 'Villa San José'],
            ['departamento_id' => 5, 'nombre' => 'Virginia'],
            ['departamento_id' => 5, 'nombre' => 'Zenón Pereyra'],
            ['departamento_id' => 6, 'nombre' => 'Aguará Grande'],
            ['departamento_id' => 6, 'nombre' => 'Ambrosetti'],
            ['departamento_id' => 6, 'nombre' => 'Arrufó'],
            ...
            ['departamento_id' => 6, 'nombre' => 'Colonia Dos Rosas y La Legua'],
            ...
            ['departamento_id' => 6, 'nombre' => 'La Clara (Colonia)'],
            ...
            ['departamento_id' => 6, 'nombre' => 'Moisés Ville'],
            ['departamento_id' => 6, 'nombre' => 'Monigotes'],
            ['departamento_id' => 6, 'nombre' => 'Monte Obscuridad'],
            ...
            ['departamento_id' => 8, 'nombre' => 'Cayastá'],
            ['departamento_id' => 8, 'nombre' => 'Colonia Mascías'],
            ...
            ['departamento_id' => 10, 'nombre' => 'San Jerónimo del Sauce'],
            ['departamento_id' => 10, 'nombre' => 'San Jerónimo Norte'],
            ['departamento_id' => 10, 'nombre' => 'San José (Colonia)'],
            ...
            ['departamento_id' => 12, 'nombre' => 'Desvío Arijón'],
            ['departamento_id' => 12, 'nombre' => 'Díaz'],
            ...
            ['departamento_id' => 12, 'nombre' => 'Loma Alta (Villa Tramontina)'],
            ['departamento_id' => 12, 'nombre' => 'López'],
            ...
            ['departamento_id' => 13, 'nombre' => 'Esther (Colonia)'],
            ['departamento_id' => 13, 'nombre' => 'Gobernador Crespo'],
            ['departamento_id' => 13, 'nombre' => 'La Camila'],
            ['departamento_id' => 13, 'nombre' => 'La Criolla'],
            ['departamento_id' => 13, 'nombre' => 'La Penca y Caraguatá'],
            ['departamento_id' => 13, 'nombre' => 'Marcelino Escalada'],
            ['departamento_id' => 13, 'nombre' => 'Naré'],
            ['departamento_id' => 13, 'nombre' => 'Pedro Gómez Cello'],
            ['departamento_id' => 13, 'nombre' => 'Ramayón'],
            ['departamento_id' => 13, 'nombre' => 'San Bernardo (Pueblo)'],
            ...
            ['departamento_id' => 15, 'nombre' => 'Chabás'],
            ...
            ['departamento_id' => 17, 'nombre' => 'Andino (Pueblo)'],
            ...
            ['departamento_id' => 17, 'nombre' => 'Lucio V. López'],
            ...
            ['departamento_id' => 17, 'nombre' => 'Villa Eloísa'],
            ...
            ['departamento_id' => 24, 'nombre' => 'Christophersen (Colonia)'],
            ...
            ['departamento_id' => 24, 'nombre' => 'María Teresa'],
            ['departamento_id' => 24, 'nombre' => 'Melincué'],
            ['departamento_id' => 24, 'nombre' => 'Miguel Torres (Pueblo)'],
            ...
            ['departamento_id' => 24, 'nombre' => 'Sancti Spíritu'],
